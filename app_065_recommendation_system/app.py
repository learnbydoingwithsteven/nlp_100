"""
NLP App 065: Recommendation System
Real-world use case: Content-based recommendations
"""
...
st.markdown("---")
st.markdown("**About**: Recommendation System - Content-based recommendations")
