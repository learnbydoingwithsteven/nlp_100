"""
NLP App 089: Content Moderation
Real-world use case: Multi-platform content filtering
"""
...
st.markdown("---")
st.markdown("**About**: Content Moderation - Multi-platform content filtering")
