"""
NLP App 097: Recipe Analysis
Real-world use case: Ingredient and instruction extraction
"""
...
st.markdown("---")
st.markdown("**About**: Recipe Analysis - Ingredient and instruction extraction")
