"""
NLP App 047: Headline Generation
Real-world use case: Automatic title creation
"""
...
st.set_page_config(
    page_title="Headline Generation",
    page_icon="🔤",
    layout="wide"
)

st.title("🔤 Headline Generation")
st.markdown("""
**Real-world Use Case**: Automatic title creation
...
st.markdown("---")
st.markdown("**About**: Headline Generation - Automatic title creation")
