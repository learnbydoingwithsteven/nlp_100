"""
NLP App 087: Customer Support Automation
Real-world use case: Ticket classification and routing
"""
...
st.markdown("---")
st.markdown("**About**: Customer Support Automation - Ticket classification and routing")
