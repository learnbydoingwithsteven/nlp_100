"""
NLP App 067: Multi-class Text Classification
Real-world use case: Multi-class document classification
"""
...
st.set_page_config(
    page_title="Multi-class Text Classification",
    page_icon="🔤",
    layout="wide"
)

st.title("🔤 Multi-class Text Classification")
st.markdown("""
**Real-world Use Case**: Multi-class document classification
...
st.markdown("---")
st.markdown("**About**: Multi-class Text Classification - Multi-class document classification")
