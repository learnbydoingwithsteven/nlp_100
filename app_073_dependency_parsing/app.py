"""
NLP App 073: Dependency Parsing
Real-world use case: Grammatical structure analysis
"""
...
st.markdown("---")
st.markdown("**About**: Dependency Parsing - Grammatical structure analysis")
