"""
NLP App 075: Word Sense Disambiguation
Real-world use case: Context-based word meaning
"""
...
st.markdown("---")
st.markdown("**About**: Word Sense Disambiguation - Context-based word meaning")
