"""
NLP App 072: Coreference Resolution
Real-world use case: Pronoun reference resolution
"""
...
st.title("🔤 Coreference Resolution")
st.markdown("""
**Real-world Use Case**: Pronoun reference resolution
...
st.markdown("---")
st.markdown("**About**: Coreference Resolution - Pronoun reference resolution")
