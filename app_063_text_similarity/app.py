"""
NLP App 063: Text Similarity
Real-world use case: Document similarity measurement
"""
...
st.markdown("---")
st.markdown("**About**: Text Similarity - Document similarity measurement")
