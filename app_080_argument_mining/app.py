"""
NLP App 080: Argument Mining
Real-world use case: Claim and evidence extraction
"""
...
st.markdown("---")
st.markdown("**About**: Argument Mining - Claim and evidence extraction")
