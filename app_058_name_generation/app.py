"""
NLP App 058: Name Generation
Real-world use case: Brand/product name creation
"""
...
st.markdown("---")
st.markdown("**About**: Name Generation - Brand/product name creation")
