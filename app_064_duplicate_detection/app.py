"""
NLP App 064: Duplicate Detection
Real-world use case: Duplicate content identification
"""
...
st.markdown("---")
st.markdown("**About**: Duplicate Detection - Duplicate content identification")
