"""
NLP App 077: Irony Detection
Real-world use case: Ironic statement identification
"""
...
st.markdown("---")
st.markdown("**About**: Irony Detection - Ironic statement identification")
