"""
NLP App 095: Bug Report Analysis
Real-world use case: Software issue classification
"""
...
st.set_page_config(
    page_title="Bug Report Analysis",
    page_icon="🔤",
    layout="wide"
)

st.title("🔤 Bug Report Analysis")
st.markdown("""
**Real-world Use Case**: Software issue classification
...
st.markdown("---")
st.markdown("**About**: Bug Report Analysis - Software issue classification")
