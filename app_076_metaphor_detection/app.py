"""
NLP App 076: Metaphor Detection
Real-world use case: Figurative language identification
"""
...
st.markdown("---")
st.markdown("**About**: Metaphor Detection - Figurative language identification")
